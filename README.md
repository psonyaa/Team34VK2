...
<p>Планируемые работы:

- сократить количество классов пользователей и количество итераций по таймфрейму
- провести кластеризацию на уровне пользователей, чтобы был не 1 пользователь = 1 объект, а более выгодный трейдоф

## Как пользоваться проектом
- здесь допишем как пользоваться тем, что мы сделаем (по завершении проектного практикума) и красиво прикрепим все ссылки на нужный код (пока что написали только проделанные шаги и планы) :)
