...
- сокращение количества классов пользователей и количество итераций по таймфрейму
- проведена кластеризация на уровне пользователей, чтобы был не 1 пользователь = 1 объект, а более выгодный трейдоф
- оптимизация гиперпараметров
- feature importance с выводом результатов
